            ...
            <div className="row">
              <div className="col-xl-4 col-lg-4 col-md-4 mb-3 mb-md-0">
                <div className="single-cta">
                  ...
                  <div className="cta-text">
                    <h4>Find us</h4>
                    <span>4, Paradise Apartment, Serene meadows,Gangapur Road,Nashik, Maharashtra India-422012</span>
                  </div>
                </div>
              </div>
              <div className="col-xl-4 col-lg-4 col-md-4 mb-3 mb-md-0">
              ...
              <div className="col-xl-4 col-lg-4 col-md-4">
                <div className="single-cta">
                  ...
                  <div className="cta-text">
                    <h4>Mail us</h4>
                    <span>unity.switchgear@gmail.com</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="footer-content pt-5 pb-5">
            <div className="row">
              ...
              <div className="col-xl-4 col-lg-4 col-md-6">
                ...
                <div className="card1" style={{ flexDirection: "row" }}>
